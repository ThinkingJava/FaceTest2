...
public class CheckAPI implements Constant {
    ...
    private static final String EYEKEY_APP_ID = "EYEKEY_APP_ID";
    private static final String EYEKEY_APP_KEY = "EYEKEY_APP_KEY";

    private static String sAppId = "93b5fd20cee045c4947594c86cd0a04a";
    private static String sAppKey = "1ae22607bbca4c3fbbf020f9696bbf1a";
     ...
     * @return
     */
    public static Call<MatchSearch> matchSearch( String faceGatherName,String faceId, int count) {
        Call<MatchSearch> call = sEyekeyManagerService.matchSearch(sAppId, sAppKey, faceGatherName, faceId, count);
        sCalls.add(call);
        return call;
    }
     ...
     * @return
     */
    public static Call<MatchSearch> matchSearch1(String faceId, String faceGatherName,String count) {
        Call<MatchSearch> call = sEyekeyManagerService.matchSearch1(sAppId, sAppKey, faceId, faceGatherName,count);
        sCalls.add(call);
        return call;
    }
